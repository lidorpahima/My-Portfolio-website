...
export default function Hero() {
  const words = [
    ...
    "Python | React | Cloud Enthusiast",
    "Building Scalable Systems",
    "Fast Learner & Innovator",
  ];

  const [code] = useState(`
const profile = {
    name: 'Lidor Pahima',
    title: 'AI & Full-Stack Developer | Cloud Enthusiast',
    skills: [
        'Python', 'React', 'Next.js', 'Node.js',
        'PostgreSQL', 'Redis', 'Docker', 'Git', 'TypeScript',
        'Django', 'FastAPI', 'Linux', 'AI/ML', 'Cloud'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    passionateAboutAI: true,
    buildScalableSystems: true,
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
            this.skills.length >= 5 &&
            this.passionateAboutAI
        );
    }
};
  `);
    ...
    <>
      <main className="bg-[#020617] text-white min-h-screen">
        ...
        >
          ...
          <div
className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-8 md:py-10 lg:py-12 md:pt-28 xl:pt-28 pt-24 sm:pt-30"            style={{
              paddingTop:
                window.innerWidth >= 1360 &&
                window.innerWidth <= 1370 &&
                window.innerHeight >= 760 &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  AI & Cloud enthusiast 🤖☁️ | Full-stack developer 💻 | Passionate about building scalable, innovative systems with Python, React & modern tech. Always learning, always creating.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://limewire.com/d/5b5sy#ouSARrYiuF"
                  className="group relative inline-flex items-center justify-center gap-3 p-0.5 rounded-xl bg-gradient-to-r from-gray-800 to-gray-700 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 border border-gray-700/50 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-gray-800 group-hover:to-gray-700">
                    <span className="relative flex items-center justify-center gap-2 text-gray-300 font-medium group-hover:text-white">
